  ...
  >
    ...
    <div className="offcanvas-body h-100 px-4 pt-0" data-simplebar="">
      <ul className="mb-0">
        <li className="pb-7">
          <div className="d-flex align-items-center">
            <img
              src="/src/assets/dist/images/products/product-1.jpg"
              width={95}
              height={75}
        ...
        <li className="pb-7">
          <div className="d-flex align-items-center">
            <img
              src="/src/assets/dist/images/products/product-2.jpg"
              width={95}
              height={75}
              className="rounded-1 me-9 flex-shrink-0"
              alt=""
        ...
        <li className="pb-7">
          <div className="d-flex align-items-center">
            <img
              src="/src/assets/dist/images/products/product-3.jpg"
              width={95}
              height={75}
              className="rounded-1 me-9 flex-shrink-0"
              alt=""
      ...
      <div className="align-bottom">
        ...
        <a href="eco-checkout.html" className="btn btn-outline-primary w-100">
          Go to shopping cart
        </a>
      </div>
    </div>
